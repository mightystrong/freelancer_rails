...
NOTE: `contact_mail.php` is not included and therefore the form will not work as shown in the original demo of the application. Adapt the mail form as needed for a rails application.
